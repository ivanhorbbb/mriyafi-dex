    ...
    return (
        <div className="w-full flex justify-center p-4 animate-fade-in relative z-10">
            ...
            <div className="
                ...
                rounded-[3rem] 
                shadow-2xl 
                bg-[#131823]/80 backdrop-blur-2xl
            ...
            ">
                ...
                <div className="absolute inset-0 rounded-[3rem] border border-white/10 pointer-events-none z-50"></div>
                    ...
                    h-[280px] w-full
                    bg-gradient-to-b from-[#131823] from-40% via-[#131823]/95 via-70% to-transparent 
                    pointer-events-none
                    px-8 pt-10 sm:px-10
                    ">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="relative flex-grow">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-[#0a0e17]/50 border border-white/10 rounded-2xl py-3 pl-12 pr-4 text-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#00d4ff]/40 focus:bg-[#0a0e17]/70 backdrop-blur-md transition-all shadow-lg"
                                    />
                                </div>

                                {/* HOT BUTTON */}
                                <button className="flex items-center gap-2 bg-[#0a0e17]/50 border border-white/10 rounded-2xl px-6 py-3 text-white hover:bg-white/5 transition-all backdrop-blur-md shadow-lg font-medium whitespace-nowrap">
                    ...
                    <div 
                        className="h-full overflow-y-auto overflow-x-hidden px-8 sm:px-10 pt-[220px] pb-10 space-y-12 custom-scrollbar relative z-10">
                        {poolsData.map((pool) => (
                            
                            <div key={pool.id} className="relative group cursor-pointer isolate min-h-[140px] transform-gpu" onClick={() => setSelectedPool(pool)}>
