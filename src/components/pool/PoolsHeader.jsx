...
const PoolsHeader = ({ 
    ...
    return (
        <div className="absolute top-0 left-0 right-0 z-40 h-[360px] md:h-[280px] w-full bg-gradient-to-b from-[#131823] from-40% via-[#131823]/95 via-70% to-transparent pointer-events-none px-4 pt-8 md:px-10 md:pt-10">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex gap-3 w-full md:w-auto">
                        ...
                        <button 
                            ...
                            className={`flex-1 md:flex-none flex items-center justify-center gap-2 border rounded-2xl px-6 py-3 transition-colors backdrop-blur-md shadow-lg font-medium whitespace-nowrap
                            ${isHotFilter
                        ...
                        <button 
                            ...
                            className="flex items-center justify-center bg-[#00d4ff] hover:bg-[#00b3d6] text-[#0a0e17] rounded-2xl px-5 py-3 transition-colors shadow-lg shadow-[#00d4ff]/20 font-bold"
                            title={t.createPool}
                        >
                            <Plus size={24} />
                        </button>
