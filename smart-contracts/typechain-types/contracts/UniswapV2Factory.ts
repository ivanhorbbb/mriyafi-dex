...
export interface UniswapV2FactoryInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "seeFeeTo", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setFeeToSetter",
    data: BytesLike
  ): Result;
...
export interface UniswapV2Factory extends BaseContract {
  ...
  seeFeeTo: TypedContractMethod<[_feeTo: AddressLike], [void], "nonpayable">;
