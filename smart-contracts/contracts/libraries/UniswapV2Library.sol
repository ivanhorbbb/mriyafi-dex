...
library UniswapV2Library {
    function sortTokens(address tokenA, address tokenB) internal pure returns (address token0, address token1) {
        ...
        require(token0 != address(0), 'UniswapV2Factory: ZERO_ADDRESSES');
    }
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal view returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
            ...
            hex'890f760c6d85ba6ad0c3fe380a728886e285127ac762e94aa24ffa61a14505a6'
        )))));
    }
    ...
    // how much we get by swap (commission 0.3%)
    ...
    // how much you need to give to receive amount
